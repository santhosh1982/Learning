...
root_agent_var_name = 'root_agent_stateful' # Default name from Step 3 guide
if 'root_agent_stateful' in globals(): # Check if user used this name instead
